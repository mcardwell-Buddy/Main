...
const SuccessFeedback = ({ goalId, messageIndex, onFeedbackSubmitted }) => {
  ...
  const handleSubmitFeedback = async () => {
    ...
    try {
      const response = await fetch('/success/submit-feedback', {
        method: 'POST',
