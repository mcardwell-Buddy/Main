...
from Back_End.task_breakdown_and_proposal import TaskBreakdown, TaskStep, StepType
...
class UnifiedProposal:
    ...
    # Scheduling & Parallelization (Phase 2)
    step_schedules: List[Dict[str, Any]] = field(default_factory=list)  # Per-step schedules
    parallelization_opportunities: List[Dict[str, Any]] = field(default_factory=list)  # Parallel execution opportunities
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'scheduling': {
                'step_schedules': self.step_schedules,
