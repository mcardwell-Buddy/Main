...
from Back_End.goal_decomposer import GoalDecomposer
from Back_End.delegation_evaluator import DelegationEvaluator, ExecutionClass, HumanAction
from Back_End.cost_estimator import CostEstimator, MissionCost, ServiceTier, ModelType
...
class TaskStep:
    ...
    # Scheduling (from StepScheduler)
    schedule: Optional[Any] = None  # StepSchedule object
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'schedule': self.schedule.to_dict() if self.schedule and hasattr(self.schedule, 'to_dict') else None,
...
class TaskBreakdownEngine:
    ...
    def _analyze_step(
        ...
        try:
            ...
            from Back_End.action_readiness_engine import ExecutionResult, ExecutionClass
