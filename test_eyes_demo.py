...
raise SystemExit("Deprecated: use test_buddys_vision_demo.py")
...
def test_buddys_vision():
    ...
    try:
        # Create Buddy's Eyes with the driver
        ...
        print("\n[EYES] Buddy now has eyes and can see!")
